...
BaseRequest = " utlegales.siren, " \
          ...
          "and etablissements.codePaysEtrangerEtablissement is not null" \
          " and etablissements.codePaysEtrangerEtablissement <> ''"

for j in range(1,10):
    cat = "create view Cat_"+str(j) + "_ETR as select "
